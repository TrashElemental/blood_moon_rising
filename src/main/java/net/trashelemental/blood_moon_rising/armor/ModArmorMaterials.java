...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    VISCERAL("visceral", 33, new int[]{3, 7, 5, 3}, 20,
            SoundEvents.ARMOR_EQUIP_LEATHER, 2.0f, 0f, () -> Ingredient.of(ModItems.EXALTED_BONE.get())),
    ...
    public String getName() {
        return BloodMoonRising.MOD_ID + ":" + this.name;
    }
