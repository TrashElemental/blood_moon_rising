...
public class BloodMoonSavedData extends SavedData {
    ...
    private static final String ID = "blood_moon_data";
    private int countdown = 0;
    private boolean active = false;

    public BloodMoonSavedData() {}

    public BloodMoonSavedData(CompoundTag tag) {
    ...
    public static BloodMoonSavedData load(CompoundTag tag) {
        return new BloodMoonSavedData(tag);
    }

    public static BloodMoonSavedData get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(BloodMoonSavedData::load, BloodMoonSavedData::new, ID);
    }
