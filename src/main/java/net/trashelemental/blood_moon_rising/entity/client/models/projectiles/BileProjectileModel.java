...
public class BileProjectileModel extends GeoModel<BileProjectileEntity> {
    ...
    public ResourceLocation getModelResource(BileProjectileEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("blood_moon_rising","geo/models/projectiles/bile_projectile.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BileProjectileEntity animatable) {

        return ResourceLocation.fromNamespaceAndPath("blood_moon_rising","textures/projectile/bile_projectile.png");
    }

    @Override
    public ResourceLocation getAnimationResource(BileProjectileEntity animatable) {
        return ResourceLocation.fromNamespaceAndPath("blood_moon_rising","animations/bile_projectile.animation.json");
    }
