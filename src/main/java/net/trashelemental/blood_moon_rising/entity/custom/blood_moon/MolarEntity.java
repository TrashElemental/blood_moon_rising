...
public class MolarEntity extends WoundMob implements GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, LivingEntity.class,
                10, true, false, entity -> entity.hasEffect(ModMobEffects.SCORN.get())));
    ...
    protected InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (player.hasEffect(ModMobEffects.KINSHIP.get()) && !this.isAggressive() && !isTrading) {
            if (item.is(ModTags.Items.MOLAR_ACCEPTS) || (!(food == null) && food.isMeat())) {
    ...
    public ResourceLocation getTexture() {
        return new ResourceLocation("blood_moon_rising",
                "textures/entity/" + (isTaintedSkin() ? "molar_tainted" : "molar") + ".png");
    }
