...
public class MosquitoEntity extends TamableAnimal implements GeoEntity {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new FollowOwnerGoal(this, 1.0, 1.0F, 1.0F, true) {
            @Override
        ...
        this.goalSelector.addGoal(7, new FollowOwnerGoal(this, 1.0, 10.0F, 5.0F, true) {
            @Override
            public boolean canUse() {
                return super.canUse() && isTame && !isFull;
            }
