...
public class ArteryEntity extends WoundMob implements GeoEntity {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(IS_MIMICKING, true);
        this.entityData.define(STRESS, 120);
    }
    ...
    public void tick() {
        ...
        if (!this.level().isClientSide && this.isMimicking()) {
            ...
            for (LivingEntity entity : this.level().getEntitiesOfClass(LivingEntity.class,
                ...
                if (entity.hasEffect(ModMobEffects.SCORN.get()) && !(entity instanceof Player player && player.isCreative())) {
                    nearScorn = true;
                    break;
                }
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        ...
        controllers.add(new AnimationController<>(this, "transformController", 0, state -> PlayState.STOP)
