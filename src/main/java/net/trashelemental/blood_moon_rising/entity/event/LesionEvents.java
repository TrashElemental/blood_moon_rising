...
public class LesionEvents {
    ...
    public static void LesionHurtTarget(Entity entity) {
        if (entity instanceof LivingEntity livingEntity && !livingEntity.hasEffect(ModMobEffects.HEALTH_DOWN)) {
            livingEntity.addEffect(new MobEffectInstance(ModMobEffects.HEALTH_DOWN,
                    300, 0, false, true));
        }
    }
