...
public class ModCreativeModeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> BLOOD_MOON_RISING_TAB = CREATIVE_MODE_TABS.register("blood_moon_rising_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.HEART.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.VISCERAL_HELMET.get());
                        output.accept(ModItems.VISCERAL_CHESTPLATE.get());
                        output.accept(ModItems.VISCERAL_LEGGINGS.get());
                        output.accept(ModItems.VISCERAL_BOOTS.get());
